...
import stylesControls from './AdminLiveStreamScoreBoardControls.scss';
...
import AdminLiveStreamEditTeam from '../../../forms/AdminLIveStreamEditTeam/AdminLIveStreamEditTeam';
import UiTicker from '@webstack/components/UiForm/components/UiTicker/UiTicker';
// ✅ correct depth (stream/views/AdminLiveStreamView/views/AdminLiveStreamScoreBoardControls -> stream/context)
...
export const AdminLiveStreamScoreBoardControls: React.FC<Props> = ({ current }) => {
    ...
    <>
      ...
      <div className="admin-live-stream-controls">
        <div className="admin-live-stream-controls__section">
          ...
          {/* The “Add Team” button stays exactly as before in terms of external API expectations */}
