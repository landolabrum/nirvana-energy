...
import styles from './OverlayPage.scss';
import CanopyMediaOverlay from '../controller/CanopyMediaOverlay';
import { LiveStreamProvider, useLiveStreamCtx } from '@Canopy/context/CanopyProvider';
import type { EventRow as EvRow, RosterRow } from '@Canopy/hooks/useLiveStream';
...
import { jsonStable } from '@Canopy/views/CanopyOverlays/canopyOverlayTypes';
...
> = ({ fullscreen, initialEventId, onResolvedEventId }) => {
  ...
  const cls = `overlay-page ${fullscreen ? 'is-fullscreen' : 'is-inline'}`;
...
const OverlayPage: React.FC<Props> = ({ fullscreen = true, eventId, onResolvedEventId }) => {
  return (
    <LiveStreamProvider eventId={eventId} prefetchRoster prefetchOverlays>
      <OverlayPageInner
        fullscreen={fullscreen}
