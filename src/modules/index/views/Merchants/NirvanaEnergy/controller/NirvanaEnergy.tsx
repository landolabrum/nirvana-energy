        ...
        >
          <FullPageBackground
            btn={{
              ...
              // style={{fontSize:"var(--s-element)", gap:"100px", fontWeight:700, lineHeight:1.2, textAlign:"center", marginBottom:"var(--s-2)"}}className='d-flex-col s-1'
              >
              Build your Nirvana
<div>
   <AdaptGrid xs={gridProps.sm} md={gridProps.md} gap={gridProps.gap} >
                    ...
                    {gridProps.icons.map((icon, index) => (
                      <div key={index} className="nirvana-energy__bg-overlay-grid-item">
                        <UiIcon icon={icon} color="var(--white)" size={gridProps.size} />
                      </div>
                    ))}                    
                  </AdaptGrid>
              </div>
            ...
            media={{
              url: "https://tiktok.soy/files/srv/nirv1/branding/nirv1_animation.webm",
              type: "video",
              loop: false,
              playbackSpeed: 0.8,
            }}
